...
public static partial class UoMRegistry {
    ...
    /// </summary>
    public static readonly Lazy<FrozenDictionary<string, List<(string Name, string Abbreviation, string Plural, double Factor)>>> UnitListCache 
    ...
    private static FrozenDictionary<string, List<(string, string, string, double)>> BuildUnitListCache() {
        var cache = new Dictionary<string, List<(string, string, string, double)>>(StringComparer.OrdinalIgnoreCase);
