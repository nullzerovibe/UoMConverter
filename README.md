...
![Build Status](https://img.shields.io/github/actions/workflow/status/your-repo/UoMConverter/dotnet.yml)
![Nuget](https://img.shields.io/nuget/v/UoMConverter)
![License](https://img.shields.io/github/license/your-repo/UoMConverter)
